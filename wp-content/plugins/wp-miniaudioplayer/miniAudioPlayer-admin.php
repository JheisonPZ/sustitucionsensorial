...
function register_miniAudioPlayerSettings() {
    ...
    register_setting( 'miniAudioPlayer-settings-group', 'miniAudioPlayer_use_html5_download' );
}
...
function miniAudioPlayer_options_page(){ // Output the options page
    ...
    <tr valign="top">
        ...
        <tr valign="top">
            <th scope="row"><?php _e('Use default browser download capabilities', 'wp-miniaudioplayer'); ?>:</th>
            <td>
                <input type="checkbox" name="miniAudioPlayer_use_html5_download" value="true" <?php if (get_option('miniAudioPlayer_use_html5_download') == "true") {
                    echo' checked="checked"';
                }?>/>
                <p><?php _e('If checked the file will be downloaded using the browser capabilities (HTML5 download attribute) otherwise it will be downloaded via PHP fOpen module', 'wp-miniaudioplayer'); ?>.</p>
            </td>
        </tr>
    </table>
